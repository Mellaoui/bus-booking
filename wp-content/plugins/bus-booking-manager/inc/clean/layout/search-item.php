...
function mage_search_item($return)
{
    ...
    if ($seat_price_adult > 0) {
        if ( $mage_bus_search_theme == 'minimal' ) : // Minimal theme design
            ?>
            <div class="mage_search_list theme_minimal <?php echo $in_cart ? 'booked' : ''; ?>" data-seat-available="<?php echo $available_seat; ?>">
                <div class="mage-search-brief-row">
                    ...
                    <div class="mage-search-res-header--left">
                        ...
                        <div>
                            ...
                            <?php echo '<p class="mage-bus-stopage"><i class="far fa-stop-circle"></i> ' . $dropping . ' ( ' . $dropping_time . ' )</p>'; ?>
                        </div>
                    </div>
